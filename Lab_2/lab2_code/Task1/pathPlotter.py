...
class ScatterPlotter:
    ...
    def plot(self,map2d, path,title):
        ...
        print("Start %s , %s" % (locStart[0][0] ,locStart[1][0]))
        ...
        for iposExpand in range(len(locExpand[0])):
            ...
            colorsMap2d[locExpand[1][iposExpand]][locExpand[0][iposExpand]] = [.0, 1.0, .0, 1.0]##colors[map2d[locExpand[0][iposExpand]][locExpand[1][iposExpand]]-1]

        for irow in range(len(colorsMap2d)):
            for icol in range(len(colorsMap2d[irow])):
                if colorsMap2d[irow][icol] == []:
                    colorsMap2d[irow][icol] = [1.0, .0, 0.0, 1.0]
