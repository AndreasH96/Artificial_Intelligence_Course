...
class KNNClassifier():
    ...
    def __init__ (self,data,K_val = 3, distanceFunctionIndex = 0):
        # assert data
        self.data = data
        self.K = K_val
        self.distanceFunctionIndex = distanceFunctionIndex
    ...
    def getKNNeighbors(self,trainingSet, dataPoint, k):
        ...
        neighborDistances = list(map(lambda 
            trainingDataPoint: (trainingDataPoint,localFunctions[distanceFunction](trainingDataPoint,dataPoint,self.DATALENGTH)) ,trainingSet))
